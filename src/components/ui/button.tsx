  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "border border-foreground/30 bg-transparent text-foreground hover:bg-foreground hover:text-background hover:shadow-[0_0_30px_rgba(0,0,0,0.3)] font-mono tracking-wide",
        tag: "border border-border bg-transparent text-foreground/80 hover:border-foreground/50 text-xs font-normal",
        icon: "border border-border bg-transparent text-foreground hover:bg-secondary rounded-full",
      },
      size: {
